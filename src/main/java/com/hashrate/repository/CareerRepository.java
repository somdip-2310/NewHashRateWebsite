...
public interface CareerRepository extends JpaRepository<Career, Long> {
    ...
    // Added missing method for urgent careers
    List<Career> findByIsUrgentTrueAndIsActiveTrueAndExpiryDateAfter(LocalDateTime currentDate);
    ...
    List<String> findDistinctLocations(@Param("currentDate") LocalDateTime currentDate);
